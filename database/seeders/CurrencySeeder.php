...
class CurrencySeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('currencies')->insertOrIgnore([
            ...
            ['code' => 'AZM', 'name' => 'Manat azerbaiyano'],
            ...
            ['code' => 'BTN', 'name' => 'Ngultrum de Bután'],
            ...
            ['code' => 'CNY', 'name' => 'Yuan Renminbi de China'],
            ['code' => 'COP', 'name' => 'Peso colombiano'],
            ['code' => 'CRC', 'name' => 'Colón costarricense'],
            ['code' => 'RSD', 'name' => 'Dinar serbio '],
            ['code' => 'CUP', 'name' => 'Peso cubano'],
            ['code' => 'CUC', 'name' => 'Peso cubano convertible'],
            ['code' => 'CVE', 'name' => 'Escudo caboverdiano'],
            ['code' => 'CYP', 'name' => 'Libra chipriota'],
            ['code' => 'CZK', 'name' => 'Koruna checa'],
            ['code' => 'DJF', 'name' => 'Franco yibutiano'],
            ['code' => 'DKK', 'name' => 'Corona danesa'],
            ['code' => 'DOP', 'name' => 'Peso dominicano'],
            ['code' => 'DZD', 'name' => 'Dinar algerino'],
            ['code' => 'EEK', 'name' => 'Corona estonia'],
            ...
            ['code' => 'GBP', 'name' => 'Libra esterlina (libra de Gran Bretaña)'],
            ...
            ['code' => 'VEF', 'name' => 'Bolívar fuerte venezolano'],
            ...
            ['code' => 'XBA', 'name' => 'European Composite Unit (EURCO) (unidad del mercado de bonos)'],
            ['code' => 'XBB', 'name' => 'European Monetary Unit (E.M.U.-6) (unidad del mercado de bonos)'],
            ['code' => 'XBC', 'name' => 'European Unit of Account 9 (E.U.A.-9) (unidad del mercado de bonos)'],
            ['code' => 'XBD', 'name' => 'European Unit of Account 17 (E.U.A.-17) (unidad del mercado de bonos)'],
            ['code' => 'XCD', 'name' => 'Dólar del Caribe Oriental'],
            ['code' => 'XDR', 'name' => 'Derecho Especial de Giro (DEG  -  FMI)'],
            ['code' => 'XFO', 'name' => 'Franco de oro (Special settlement currency)'],
            ['code' => 'XFU', 'name' => 'Franco UIC (Special settlement currency)'],
            ['code' => 'XOF', 'name' => 'Franco CFA de África Occidental'],
            ['code' => 'YER', 'name' => 'Rial yemení (de Yemen)'],
